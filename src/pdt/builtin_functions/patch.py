...
class DoPatchApply(object):
    ...
    def build_arg_parser(self, argparser):
        patch_apply = argparser.add_parser('apply',
                help='Apply all outstanding patches')
...
class DoPatchDrop(object):
    ...
    def build_arg_parser(self, argparser):
        patch_apply = argparser.add_parser('drop',
                help='Drop all outstanding patches')
...
class DoPatchList(object):
    ...
    def build_arg_parser(self, argparser):
        patch_apply = argparser.add_parser('list',
                help='List all outstanding patches')
...
class DoPatchRefreshPatches(object):
    ...
    def build_arg_parser(self, argparser):
        patch_apply = argparser.add_parser('refresh',
                help='Refresh all outstanding patches')
        patch_apply.set_defaults(func=self.do_list)
